...
Sentinel Care is a static Netlify app for Sentinel Prime's tech support subscription service at `care.sentinelprime.org`.
...
```bash
SITE_URL=https://care.sentinelprime.org
...
```text
https://care.sentinelprime.org/.netlify/functions/stripe-webhook
```
...
- Add `https://care.sentinelprime.org/portal.html` and `https://care.sentinelprime.org/admin.html` as allowed redirect URLs.
...
2. Set the custom domain to `care.sentinelprime.org`.
